...
export default function CheckoutPage() {
  ...
  async function submit(event: FormEvent) {
    event.preventDefault(); if (!user || !profile) return; setBusy(true);
    try {
